$(document).ready(function() {
    ...
    $("#searchR").on('click', async function(e) {
        ...
        try {
            ...
            chrome.runtime.sendMessage({command: 'loadNew', DAG: r.data.result.DAG, tutorial_name: r.data.result.name, description: r.data.result.description, id: r.data.result.root_node_id});
            loaded = true;
